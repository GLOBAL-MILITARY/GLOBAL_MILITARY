...
# Countries ranked 6-50 that need detailed navy and airforce data
countries_to_update = [
    "PAK", "JPN", "TUR", "GBR", "FRA", "ITA", "BRA", "IDN", "EGY", "UKR",  # 6-15
    "IRN", "VNM", "POL", "ESP", "AUS", "PRK", "THA", "DEU", "TWN", "ISR",  # 16-25
    "CAN", "MEX", "SAU", "SWE", "GRC", "NOR", "ROM", "CZE", "NLD", "BEL",  # 26-35
    "PRT", "FIN", "CHE", "AUT", "DNK", "HUN", "BGR", "SRB", "CHL", "ARG",  # 36-45
    "PER", "COL", "MYS", "ZAF", "PHL"  # 46-50
]
...
print("\nCompleted! Updated detailed navy and airforce data for countries ranked 6-50.")
