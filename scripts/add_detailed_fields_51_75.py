...
# Countries ranked 51-75 that need detailed navy and airforce data
countries_to_update = [
    "SGP", "AZE", "KAZ", "DZA", "MAR", "NGA", "ETH", "CUB", "BLR", "VEN",  # 51-60
    "IRQ", "SYR", "MMR", "ECU", "JOR", "LKA", "OMN", "KWT", "BGD", "HRV",  # 61-70
    "SVK", "QAT", "ARE", "PRI", "KEN"  # 71-75
]
...
print("\nCompleted! Updated detailed navy and airforce data for countries ranked 51-75.")
